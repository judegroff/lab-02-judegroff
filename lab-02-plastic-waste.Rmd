...
ggplot(plastic_waste, aes(x = plastic_waste_per_cap)) +
  ...
  labs(title = "Distribution of Plastic Waste per Capita by Continent",
       ...
       y = "count")
```
It seems the more populated, growing and/or "rich" continents seem to make more plastic waste.
...
Because the continent category has solid colors linked to its data, and the alpha level can alter the density of these colors.
...
ggplot(data = plastic_waste, 
  ...
  geom_violin()
```
It reveals a more accurate representation of North Americas plastic waste, that is not easily seen in the box plot.
...
ggplot(plastic_waste, aes(x = plastic_waste_per_cap, y = mismanaged_plastic_waste_per_cap)) +
  geom_point() +
  labs(title = "Plastic waste vs. mismanaged plastic waste per capita",
       x = "Plastic waste",
...
```{r, eval=TRUE}
ggplot(plastic_waste, aes(x = plastic_waste_per_cap, y = mismanaged_plastic_waste_per_cap, colour = continent, fill = continent)) +
  geom_point() +
  labs(title = "Plastic waste vs. mismanaged plastic waste per capita",
       x = "Plastic waste",
       y = "Mismanaged plastic waste")
...
ggplot(plastic_waste, aes(x = plastic_waste_per_cap, y = total_pop)) +
  geom_point(size = 0.6) +
  labs(title = "Plastic Waste of each Capita and it's Population",
       x = "Plastic waste per capita",
       y = "Capita population")
```
...
ggplot(plastic_waste, aes(x = plastic_waste_per_cap, y = coastal_pop)) +
  geom_point(size = 0.6) +
  labs(title = "Plastic Waste of each Capita and it's Coastal Population",
       x = "Plastic waste per capita",
       y = "Capita coastal population")
```
The coastal population plot seems to be more linear.
